...
CREATE TABLE Event ( ID INT AUTO_INCREMENT PRIMARY KEY, EventTypeID INT, Date DATE, Time TIME, Location VARCHAR(255), MaxCapacity INT, FOREIGN KEY (EventTypeID) REFERENCES EventType(ID) );
